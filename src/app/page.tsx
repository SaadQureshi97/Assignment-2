export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen pt-8 pb-8 space-y-10 -mt-20 w-[990px] m-auto">
      ...
      <div className="flex flex-col items-center text-center w-[550px] p-12 space-y-4">
        ...
        <h1 className="text-white text-[58px] leading-[80px] tracking-[0.2px] pt-3 font-montserrat">
          Selling on the internet like a pro
        </h1>
        <h4 className="text-white text-[20px] leading-[30px] tracking-[0.2px] pt-3 font-montserrat">
          We know how large objects will act, but things on a small scale just do not act that way.
        </h4>

        {/* Button Div */}
        <div className="flex space-x-2 pt-4">
          <button className="rounded-[5px] px-[25px] py-2 bg-[#23A6F0] text-white text-[14px] leading-[22px] tracking-[0.2px] font-montserrat">
            Get Quote Now
          </button>
          <button className="rounded-[5px] px-[25px] py-2 border border-[#23A6F0] text-white text-[14px] leading-[22px] tracking-[0.2px] font-montserrat">
            Learn More
          </button>
        </div>
      </div>
  ...
  <div className="bg-[#FFFFFF] rounded w-80 h-72 pt-8 px-12">
    <div className="flex flex-col items-start">
      ...
      <p className="text-[#737373] text-[14px] leading-[20px] tracking-[0.2px] pt-5 font-montserrat">
  ...
  <div className="bg-[#23A6F0] p-4 rounded w-80 h-72 pt-8 px-12 ">
    <div className="flex flex-col items-start">
      ...
      <h5 className="text-[#FFFFFF] text-[16px] leading-[24px] tracking-[0.1px] pt-4 font-montserrat">
        Training Courses
      </h5>
      <div className="w-[50px] h-[2px] bg-[#FFFFFF] mt-4 "></div>
      <p className="text-[#FFFFFF] text-[14px] leading-[20px] tracking-[0.2px] pt-5 font-montserrat">
        The gradual accumulation of information about atomic and small-scale behaviour...
      </p>
    </div>
  </div>
